...
class ExampleTest extends TestCase
{
    ...
    public function test_the_application_returns_a_correct_info()
    {
        Http::fake([
            'https://api.themoviedb.org/3/movie/*?api_key=8ed40e121ef00a7cda48c64fa354d419' => $this->fakeSingleMovie(),
        ]);
    ...
    public function test_the_application_search_dropdown_works()
    {
        Http::fake([
            'https://api.themoviedb.org/3/search/movie?query=jumanji&api_key=8ed40e121ef00a7cda48c64fa354d419' => $this->fakeSearchMovies(),
        ]);
